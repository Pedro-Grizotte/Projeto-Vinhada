    ...
    return (
        <footer className="bg-gray-900 text-white">
            <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-7">
                ...
                md:w-2/5"><span className='text-teal-400'>Free</span> until you`re ready to launch</h1>
                <div>
                    <input type="text" placeholder='Enter your e-mail...' className="text-gray-800 
                    bg-white/10 placeholder:text-gray-400 sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 
